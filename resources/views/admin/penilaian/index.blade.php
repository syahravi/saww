            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.penilaian.edit', $santri_id) }}" class="btn btn-warning">
                                <i class="bx bx-edit"></i> Ubah
                            </a>
                            <form id="delete-form-{{ $santri_id }}" action="{{ route('admin.penilaian.destroy', $santri_id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
                                <button type="button" class="btn btn-danger" onclick="confirmDelete({{ $santri_id }})">
